...
- **weekAnchor = the Eastern calendar DATE of the first week-1 game** (real 2026 example, confirmed by the Phase 6 flip drill 2026-08-08: kickoff `2026-09-10T00:20Z` → Eastern `2026-09-09T20:20:00-04:00` → anchor `2026-09-09`, a **Wednesday** — the NFL moved the 2026 opener off its usual Thursday slot to make room for the Rams@49ers Melbourne, Australia game). Never derive the anchor from the UTC date — that's off by one for every night game. Never assume the anchor lands on a Thursday either — see A4 below.
...
A4  weekAnchor equals the Eastern date of the earliest week-1 game (internal consistency, re-derived from raw data — NOT a Thursday-only assumption; a non-Thursday opener prints informationally and WARNS, never fails — 2026 opens Wednesday, see the weekAnchor note above)
